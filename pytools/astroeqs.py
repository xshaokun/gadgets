...
def cs(gamma=5.0 / 3.0, mu=0.61, **kw):
    """Sound Speed
    ...
    **keywords:
    ...
    if "T" in kw:
        ...
        try:
            ...
            print(
                f"The keyword {kw} is unvalid, you should input either T or (P & rho)"
            )
        else:
...
def radcool(temp, zmetal):
    ...
    for i, t in enumerate(tempflt):
        ...
        if tlog >= 6.1:
            ...
            arg = 10.0 ** (-(tlog - 4.9) / 0.5) + 0.077302
